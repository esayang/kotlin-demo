package com.easyang.base.utils.statusbar;
...
public class Eyes {
     ...
     */
    public static void setPadding(Activity context, View view) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT && view.getTag() == null) {
